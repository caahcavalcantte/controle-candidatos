...
public class ProcessoSeletivo {
  ...
  static void entrandoEmContato(String candidato) {
    ...
    if (atendeu)
      ...
      System.out.println(
          "Não conseguimos contato com " + candidato + ", número maximo tentativas " + tentativasRealizada + "realizada");
  }
  ...
  static void imprimirSelecionados() {
    String[] candidatos = { "Felipe", "Marcia", "Julia", "Paulo", "Augusto" };
    System.out.print("Imprimindo a lista de candidatos informando o índice  do elemento");

    for (int indice = 0; indice < candidatos.length; indice++) {
      System.out.print("O candidato de nº " + (indice + 1) + " é " + candidatos[indice]);
    }
